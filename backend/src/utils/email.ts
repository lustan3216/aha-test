...
export function verifyTemplate(verifyLink: string) {
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">EXPIRE IN AN HOUR...</div><div></div></div></td>
      </tr>
    </tbody>
